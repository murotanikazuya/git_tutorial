...
//    SHM_MSEC(1) = OsQueryMsecCount();
    ...
    if(HydraOnlyUpperbody)
        ...
        eha_state[eha_num_hydra].DATA.pos_act = eha_state[eha_num_hydra].DATA.rawpos_act*eha_phys_pos_hydra_MD4KW_3M[loop_jnt][ch_num];
...
static EC_T_DWORD myAppPdoOutput(T_ALL_SLAVE_INFO* pAllSlv)
{
    ...
    if(HydraOnlyUpperbody)
        ...
        TmpRecv.Axis0_PosRefOut = (EC_T_DWORD) (all_EHA_pos_out[joint_num_hydra_MD4KW_3M[loop_jnt][0]]/eha_phys_pos_hydra_MD4KW_3M[loop_jnt][0]);
        TmpRecv.Axis1_PosRefOut = (EC_T_DWORD) (all_EHA_pos_out[joint_num_hydra_MD4KW_3M[loop_jnt][1]]/eha_phys_pos_hydra_MD4KW_3M[loop_jnt][1]);
        TmpRecv.Axis2_PosRefOut = (EC_T_DWORD) (all_EHA_pos_out[joint_num_hydra_MD4KW_3M[loop_jnt][2]]/eha_phys_pos_hydra_MD4KW_3M[loop_jnt][2]);
...
//body
		                      snprintf(pTmpBuf,DATA_BUF_SIZE,
					       "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,"/*%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,"*/,
                            eha_state_log[0].DATA.pos_act,
                            eha_cmd_log[0].DATA.pos_ref,
                            eha_state_log[1].DATA.pos_act,
			    eha_cmd_log[1].DATA.pos_ref,
			    ...
			    eha_cmd_log[17].DATA.pos_ref,
                            eha_state_log[0].DATA.tau3_act,
			    eha_state_log[0].DATA.tau2_act,
                            eha_state_log[9].DATA.tau3_act,
			    eha_state_log[9].DATA.tau2_act
