...
#ifndef HYDRACONSOLE_DEPRECATED_HH
# define HYDRACONSOLE_DEPRECATED_HH
...
//  void foo () HYDRACONSOLE_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar HYDRACONSOLE_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a HYDRACONSOLE_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define HYDRACONSOLE_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define HYDRACONSOLE_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define HYDRACONSOLE_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HYDRACONSOLE_DEPRECATED_HH
